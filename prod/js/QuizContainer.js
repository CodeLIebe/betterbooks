class QuizContainer extends HTMLElement {
	...
	//class .container replaced by bootstrap classes: w-50 py-3 bg-light
		...
		<div id="modal-wrapper" class="modal">
          <div id="startScreen" class="modal-content w-50 py-3 bg-light text-center align-middle text-dark">
					<div class="py-5">
          ...
          <div id="endScreen" class="modal-content w-50 py-3 bg-light text-center text-dark" style="display: none">
					<div class="py-5">
               ...
               <div id="question" class="modal-content w-50 py-3 bg-light text-center text-dark" style="display: none">
